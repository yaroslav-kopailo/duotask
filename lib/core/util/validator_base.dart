...
final RegExp _fullNameStrictRegex = RegExp(
...
class _Validator {
  ...
  bool fullName(String input) => _fullNameRegex.hasMatch(input);
  bool fullNameStrict(String input) => _fullNameStrictRegex.hasMatch(input);
