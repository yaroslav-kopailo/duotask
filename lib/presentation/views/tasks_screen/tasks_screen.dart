...
class _TasksScreenState extends State<TasksScreen>
  ...
  final _taskListViewModel = sl<TaskListViewModel>();
  ...
  Widget build(BuildContext context) {
    return Provider<TaskListViewModel>(
      create: (context) => _taskListViewModel,
      child: SafeArea(
        child: Scaffold(
          body: RetryRequestHandler(
            ...
            child: DefaultFailuresHandler(
              failures: [
                ...
                _taskListViewModel
                    .tasksListController.requestReorderItem.failure,
                _taskListViewModel
                    .tasksListController.requestRemoveItem.failure,
              ],
              child: Column(
                children: [
                  TabBar(
